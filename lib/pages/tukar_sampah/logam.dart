...
class SubListLogam extends StatefulWidget {
  ...
  @override
  _SubListLogamState createState() => _SubListLogamState();
}

class _SubListLogamState extends State<SubListLogam> {
  List<Map> availableSubLogam = [
    {"name": "Kaleng/seng", "isChecked": false},
    {"name": "Besi Super", "isChecked": false},
    {"name": "Almunium(Larutan Kaleng)", "isChecked": false},
  ];
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child:
            ...
            Column(
                children: availableSubLogam.map((logam) {
              return CheckboxListTile(
                  value: logam["isChecked"],
                  title: Text(
                    logam["name"],
